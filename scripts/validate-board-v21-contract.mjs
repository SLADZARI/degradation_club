...
expect(integrations.includes("activeFilter='member';applyFilter();closeDrawer()"),'own-card locator must reveal Member cards before canonical spatial focus runs');
