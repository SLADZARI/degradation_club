...
expect(css.includes('.dc-spatial-controls [data-slot]{display:none!important}'),'legacy slot control must remain hidden in fullscreen');
expect(!css.includes('.dc-spatial-controls [data-slot],.dc-spatial-controls [data-mine]{display:none!important}'),'own-card locator must not be hidden with the slot control');
