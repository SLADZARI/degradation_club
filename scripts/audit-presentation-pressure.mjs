...
if(css.includes("@import url('/course-bridge-v1.css')")) errors.push('presentation-standard-v1.css must not globally import course-bridge-v1.css');
...
console.log('Presentation pressure audit passed: baseline layer has 0 !important, no course-only import, and contracts remain present');
