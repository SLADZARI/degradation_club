...
for(const [rel,label] of [['global-header.js','GlobalHeader'],['community-runtime-v1.js','Community runtime'],['workspace/workspace.js','Workspace guest gate'],['workspace/owner-admin-gate-v1.js','Owner-admin gate']]){
