...
const workspaceShell=read('workspace/workspace-shell-v1.js');
...
requireSyntax('workspace/workspace-shell-v1.js');
requireSyntax('workspace/workspace-route-bridge-v1.js');
...
requireText(workspaceIndex,'data-workspace-sidebar','Workspace shared shell host');
requireText(workspaceIndex,'workspace-shell-v1.js','Workspace shared shell runtime');
requireText(workspaceShell,'COMMUNITY BOARD','Workspace Board navigation');
requireText(workspaceShell,'MY ARTIFACTS','Workspace Artifact history navigation');
requireText(workspaceShell,'data-global-logout','Workspace explicit logout');
requireText(workspaceShell,'MEMBERSHIP REVIEW','Workspace Dementor role tool');
requireText(workspaceShell,'SYSTEM TOOLS','Workspace owner-admin role tool');
requireText(reviewIndex,'data-workspace-sidebar','Review shared Workspace shell host');
requireText(reviewIndex,'workspace-shell-v1.js','Review shared Workspace shell runtime');
...
requireText(artifactsIndex,'data-workspace-sidebar','Artifacts shared Workspace shell host');
requireText(artifactsIndex,'workspace-shell-v1.js','Artifacts shared Workspace shell runtime');
...
requireText(boardIndex,'telegram-worker-trigger-v3.js?v=20260831-02','Telegram worker trigger cache bust');
