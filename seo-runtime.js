(()=>{
  ...
  const inkLayoutRoutes=new Set(['/','/about/','/projects/logic-awareness/','/community/']);
  if(inkLayoutRoutes.has(location.pathname)&&!document.querySelector('script[src="/ink-layout-v2.js"]')){
