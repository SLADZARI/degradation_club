export const NODE_SPECS = Object.freeze({
  ...
  agree:{family:'REACTION',title:'СОГЛАСИТЬСЯ',description:'соглашается; снижает TENSION, повышает CONTACT и может остановить чужой REPEAT',defaults:{}},
  joke:{family:'REACTION',title:'ПОШУТИТЬ',description:'шутит; снижает TENSION и поддерживает CONTACT, но не считается согласием',defaults:{}},
  silent:{family:'REACTION',title:'ПРОМОЛЧАТЬ',description:'молчит; экономит ENERGY, но немного повышает TENSION и снижает CONTACT',defaults:{}},
