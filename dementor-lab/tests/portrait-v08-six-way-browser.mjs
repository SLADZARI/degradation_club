...
for(const combo of combos){
  ...
  results.push({key:`${combo.preset}/${combo.objective}`,punch,hotPatch:localHot});
  await page.close();
}
...
console.log(`portrait v0.8 six-way browser: PASS; hot patches exercised=${hotPatchCount}; archive persisted=6`);
await browser.close();
