...
for(const id of ['app','person-preview','to-brain','brain-graph','brain-editor','replay-note','to-setup','play','actor-a','actor-b','turn','metrics','dialogue','delta','next-turn','trace-btn','result-title','result-cause','result-node','comparison','rerun','overlay']){
