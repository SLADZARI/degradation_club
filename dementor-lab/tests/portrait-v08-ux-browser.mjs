...
for(const viewport of viewports){
  ...
  await page.locator('#start').click();await noOverflow('talk');
...
console.log('portrait v0.8 quantitative UX browser gate: PASS — 320/390px widths, touch targets, type, portrait dominance, two-metric TALK and speaker state');
await browser.close();
