...
gateReadiness: CLEAN_RC_VALIDATION_IN_PROGRESS
g5FinalStatus: PASS
...
g7ValidationStatus: IN_PROGRESS
g7CleanRcPreparationAuthorized: true
---

# Artifact Collaboration v1 · Result v1.0

## Current state

Artifact Collaboration v1 is in G7 Release candidate validation.

Clean release branch:

`release/artifact-collaboration-v1`
...
The clean RC tree is byte-for-byte/mode-for-mode identical to the validated G6 candidate tree.

Current exact-head Site Integrity:

```text
run       #1308
run id    36198771555
head      030d7fece9dee1b8502bde6ac89bef95dbdfeda7
status    IN_PROGRESS
```
...
G7 exact-head Site Integrity            IN_PROGRESS

overall Result gate                     G7_RELEASE
g7CleanRcStatus                         IN_PROGRESS
gate readiness                          CLEAN RC VALIDATION IN PROGRESS
