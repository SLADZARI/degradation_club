...
gateReadiness: G7_RC_VALIDATION_BLOCKED
g5FinalStatus: PASS
...
releaseBranch: release/artifact-collaboration-v1
releaseCandidateCommit: 030d7fece9dee1b8502bde6ac89bef95dbdfeda7
releasePullRequest: 243
g7CleanRcStatus: BLOCKED
g7ValidationRun: 1308
g7ValidationRunId: 36198771555
g7ValidationStatus: FAILURE
...
g7ValidationConclusion: FAILURE
---

# Artifact Collaboration v1 · Result v1.1

## Current state

Artifact Collaboration v1 remains in G7 Release validation but the current clean RC is **BLOCKED**.

```text
release candidate  030d7fece9dee1b8502bde6ac89bef95dbdfeda7
PR                 #243
Site Integrity     #1308 / 36198771555
attempt 2          FAILURE
```

Attempt 1 failed on the desktop Space keyboard event target. The exact-head rerun used the same immutable RC and failed on a different mobile 390 page error:

```text
Cannot read properties of null (reading 'insertBefore')
```

Board Relations browser acceptance passed before the second failure, but deeplink/auth-return, WebKit, route manifest and production artifact release gate were skipped downstream.

Canonical blocker evidence:

`operations/ARTIFACT_COLLABORATION_G7_RC_BLOCKER_2026-09-26.md`

No release or deploy action is authorized while this blocker remains.
...
G7 clean RC exact-tree identity         PASS
G7 exact-head Site Integrity            FAILURE
G7 status                               BLOCKED

overall Result gate                     G7_RELEASE
gate readiness                          G7_RC_VALIDATION_BLOCKED
