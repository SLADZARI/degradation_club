...
# MP | Dementor Club | RELEASE | Artifact Detail Terminal State v1 | Result v0.3
...
validationRunId = 35629843997
validationConclusion = SUCCESS
previousValidationRunNumber = 1225
previousValidationRunId = 35629731586
previousValidationFailure = canonical non-member Join recovery missing
previousRegressionCorrected = true
backendProductionDeployRequired = false
liveDatabaseMutationRequired = false
stagingDependency = false
```
