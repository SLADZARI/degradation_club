...
Approved shared parameters (event-scoped GA4 custom dimensions):
- `entity_type`
- `entity_id`
- `placement`
- `source_page`
...
No other custom event parameters are approved in v1.
Never send email, name, phone, auth/session tokens, Supabase IDs, assessment answers/answer arrays or free-form text.
