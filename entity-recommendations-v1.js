(()=>{
  const entities=[
    ...
    {id:'PROGRAM-001',type:'program',name:'ДУМАЙ С ОПАСНОСТЬЮ',url:'/courses/dumai-s-opasnostyu/',asset:'/assets/courses/dumai-s-opasnostyu/home-hero.webp',state:'PRODUCTION STAGE 1',status:'approved',idea:'Курс последовательной деградации уверенности.',tags:['thinking','uncertainty','home'],slots:['HOME_FEATURED','POST_JOIN_RESULT'],priority:60}
  ];
