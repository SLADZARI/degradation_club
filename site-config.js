...
if(typeof document!=='undefined'){
  (()=>{
    ...
    if(location.pathname.includes('/join')&&!document.querySelector('script[data-dc-account-sync-v6]')){
      const a=document.createElement('script');a.src='/dementor-account-sync-v6.js?v=20260828-12';a.defer=true;a.dataset.dcAccountSyncV6='20260828-12';document.head.appendChild(a);
    }
