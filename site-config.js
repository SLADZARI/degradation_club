...
if(typeof document!=='undefined'){
  (()=>{
    ...
    if(location.pathname.includes('/join')&&!document.querySelector('script[data-dc-account-sync-v4]')){const s=document.createElement('script');s.src='/dementor-account-sync-v4.js?v=20260828-5';s.defer=true;s.dataset.dcAccountSyncV4='20260828-5';document.head.appendChild(s)}
