...
if(typeof document!=='undefined'){
  (()=>{
    ...
    if(location.pathname.includes('/join')&&!document.querySelector('script[data-dc-account-sync-v3]')){const s=document.createElement('script');s.src='/dementor-account-sync-v3.js?v=20260828-4';s.defer=true;s.dataset.dcAccountSyncV3='20260828-4';document.head.appendChild(s)}
