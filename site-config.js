...
if(typeof document!=='undefined'){
  (()=>{
    ...
    if(location.pathname.includes('/join')&&!document.querySelector('script[data-dc-account-sync-v2]')){const s=document.createElement('script');s.src='/dementor-account-sync-v2.js?v=20260828-3';s.defer=true;s.dataset.dcAccountSyncV2='20260828-3';document.head.appendChild(s)}
