...
if(typeof document!=='undefined'){
  (()=>{
    ...
    const runtimePath=path.replace(/^\/degradation_club(?=\/|$)/,'')||'/';
    const isWorkspaceShell=runtimePath.startsWith('/workspace/');
    ...
    if(isJoinAssessment){
      addScript('/dementor-account-sync-v10.js?v=20260908-01',{module:true});
